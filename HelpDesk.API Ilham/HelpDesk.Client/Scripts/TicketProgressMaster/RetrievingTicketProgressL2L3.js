    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, val) {
                ...
                html += '<td>' + val.Staffs.Roles.Name + '</td>';
...
function GetById(Id) {
    $.ajax({
        ...
        success: function (result) {
            ...
            //$('#DayCombo').text(result.Tickets.Priorities.Days);
...
function ValidationSave() {
    ...
    if ($('#Solution').val() == "" || ($('#Solution').val() == " ")) {
        ...
        $('#Solution').siblings('span.error').css('visibility', 'visible'); //notifikasi validasi muncul
    }
    else {
